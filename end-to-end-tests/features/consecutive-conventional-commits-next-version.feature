Feature: A repository using Conventional Commits 1.0.0 can apply the commit messages in a consecutive order to determine the next Semantic Versioning 2.0.0.
