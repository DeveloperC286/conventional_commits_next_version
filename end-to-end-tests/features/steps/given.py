...
def reset_context(context):
    ...
    context.pre_command = ""
    context.conventional_commits_next_version_path = f"{context.behave_directory}/../target/x86_64-unknown-linux-musl/debug/conventional_commits_next_version"  # fmt: off
