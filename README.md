...
A tooling and language agnostic utility to calculate the next Semantic Versioning using the Conventional Commits since the prior version, with monorepo support.
