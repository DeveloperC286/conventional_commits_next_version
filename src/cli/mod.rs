...
pub(crate) struct Arguments {
    #[arg(
        long,
        help = "The next semantic version is calculated only from commits altering files which start with any of these provided path prefixes, enabling usage within monorepos."
    )]
